...
class Locked extends Component{
	...
	componentWillMount() {
		ApplicationService.isAuthenticated().then((result => {
...
const mapDispatchToProps = dispatch => ({
    setUserIsLoggedIn: (isAuthenticated) => dispatch(actions.setUserIsLoggedIn(isAuthenticated))
});

const ConnectedLocked = withRouter(
    connect(mapStateToProps, mapDispatchToProps)(Locked)
);
